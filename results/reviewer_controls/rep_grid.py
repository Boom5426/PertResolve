...
Usage:
  python rep_grid.py [--base /path/to/processed-data] [--out /path/to/output_dir]
  PERTRESOLVE_DATA=/path/to/processed-data python rep_grid.py
"""
import argparse
import os
import sys
...
# committed rep_grid_summary.csv in place. Naming a scratch directory is now required.
ap.add_argument("--out", required=True,
                help="directory to write rep_grid_summary.csv into; may not be inside results/")
args = ap.parse_args()
