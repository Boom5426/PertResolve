...
Usage:
  python am_analysis.py [--base /path/to/VCCompass] [--out /path/to/output_dir]
  VCCOMPASS_BASE=/path/to/VCCompass python am_analysis.py
"""
import argparse
import os
import sys
...
# Documented default: the compute workspace described in the repository CLAUDE.md.
...
ap.add_argument("--base", default=os.environ.get("VCCOMPASS_BASE", DEFAULT_BASE),
                help="VCCompass compute workspace holding unified/ and esm2_control/ "
                     "(env: VCCOMPASS_BASE)")
ap.add_argument("--out", default=HERE, help="directory to write the result tables into")
args = ap.parse_args()
