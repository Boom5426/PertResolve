...
\begin{tikzpicture}[x=1mm,y=1mm]
  ...
  \node[anchor=north west,inner sep=0] at (4.50,156.00)  {\includegraphics[width=59.07mm]{fig6a_pipeline.pdf}};
  \node[anchor=north west,inner sep=0] at (68.57,156.00) {\includegraphics[width=45.94mm]{fig6b_roc.pdf}};
  \node[anchor=north west,inner sep=0] at (119.51,156.00){\includegraphics[width=60.99mm]{fig6c_auroc.pdf}};
  % ---- row 2 (common height 42.642 mm): d prospective | e design landscape | f depth-match
  \node[anchor=north west,inner sep=0] at (4.50,105.69)  {\includegraphics[width=58.09mm]{fig6d_prospective.pdf}};
  \node[anchor=north west,inner sep=0] at (67.59,105.69) {\includegraphics[width=52.73mm]{fig6e_design.pdf}};
  \node[anchor=north west,inner sep=0] at (125.33,105.69){\includegraphics[width=55.17mm]{fig6f_depthmatch.pdf}};
  % ---- row 3: g power-aware reporting protocol (decision half), full content width
  \node[anchor=north west,inner sep=0] at (4.50,57.05)   {\includegraphics[width=176mm]{fig6g_workflow.pdf}};
