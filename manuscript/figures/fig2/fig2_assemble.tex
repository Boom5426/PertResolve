...
\begin{tikzpicture}[x=1mm,y=1mm]
  ...
  \node[anchor=north west,inner sep=0] at (6,166.5)   {\includegraphics[width=59.51mm]{fig2a_evaluation.pdf}};
  \node[anchor=north west,inner sep=0] at (71,166.5)  {\includegraphics[width=58.51mm]{fig2b_pds_forest.pdf}};
  \node[anchor=north west,inner sep=0] at (135,166.5) {\includegraphics[width=44.51mm]{fig2c_pearson_forest.pdf}};
  % ---- row 2 (h 44.51): d PDS-vs-Pearson scatter | e DE fidelity gradient ---
  \node[anchor=north west,inner sep=0] at (6,97.5)    {\includegraphics[width=76.51mm]{fig2d_scatter.pdf}};
  \node[anchor=north west,inner sep=0] at (88.5,97.5) {\includegraphics[width=91.01mm]{fig2e_de_gradient.pdf}};
  % ---- row 3 (h 44.51): f per-gene gap | g representative TP53 variants -----
  \node[anchor=north west,inner sep=0] at (6,47.5)    {\includegraphics[width=46.51mm]{fig2f_gene_gap.pdf}};
  \node[anchor=north west,inner sep=0] at (58.5,47.5) {\includegraphics[width=121.01mm]{fig2g_pervariant.pdf}};
